		...
		<div class="header-main">
			...
			<div class="navg">
				...
				<ul class="res">
					...
					<li><a class="ser active" href="introduce">展示</a></li>
		...
		<div class="service-main">
			...
			<div class="service-left wow bounceIn" data-wow-delay="0.4s">
			   <div class="service-right">
				    <img src="/futurelib/Public/images/s1.jpg" alt=""/>
			    ...
			    <div class="service-right ser-midd wow bounceIn" data-wow-delay="0.4s">
				    <img src="/futurelib/Public/images/s2.jpg" alt=""/>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book.It has survived not only five centuries</p>
				    <div class="ser-bwn">
				    	<a href="#" class="hvr-grow-shadow">Read More</a>
				    </div>
			    ...
			    <div class="service-right wow bounceIn" data-wow-delay="0.4s">
				    <img src="/futurelib/Public/images/s3.jpg" alt=""/>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
				    <div class="ser-bwn">
				    <a href="#" class="hvr-grow-shadow">Read More</a>
				    </div>
				...
				<div class="service-right wow bounceIn" data-wow-delay="0.4s">
				    <img src="/futurelib/Public/images/s4.jpg" alt=""/>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
				    <div class="ser-bwn">
				   <a href="#" class="hvr-grow-shadow">Read More</a>
				    </div>
			   ...
			   <div class="service-right ser-midd wow bounceIn" data-wow-delay="0.4s">
				    <img src="/futurelib/Public/images/s6.jpg" alt=""/>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
				    <div class="ser-bwn">
				    	<a href="#" class="hvr-grow-shadow">Read More</a>
				    </div>
			   ...
			   <div class="service-right wow bounceIn" data-wow-delay="0.4s">
				    <img src="/futurelib/Public/images/s7.jpg" alt=""/>
				    <p>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
				    <div class="ser-bwn">
				    <a href="#" class="hvr-grow-shadow">Read More</a>
				    </div>
