...
<link href="/futurelib/Public/css/hover.css" rel="stylesheet" media="all">
<!-- Custom Theme files -->
		...
		<div class="header-main">
			...
			<div class="navg">
				...
				<ul class="res">
					...
					<li><a class="ser active" href="/futurelib/index.php/Home/Index/news">动态</a></li>
		...
		<div class="projects-main">
			  ...
			  <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
				 <div class="project-img">
					<img src="/futurelib/Public/images/p1.jpg" alt=""/>
				 </div>
			 ...
			 <div class="p-single">
			  ...
			  <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
				 <div class="project-img">
					<img src="/futurelib/Public/images/p4.jpg" alt=""/>
				 </div>
				 <div class="project-text">
			 ...
			 <div class="p-single">
			  ...
			  <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
				 <div class="project-img">
					<img src="/futurelib/Public/images/p5.jpg" alt=""/>
				 </div>
				 <div class="project-text">
		 ...
		 <div class="clearfix"> </div>
		 <!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="192.168.191.1" data-title="请替换成文章的标题" data-url="请替换成文章的网址"></div>
<!-- 多说评论框 end -->
<!-- 多说公共JS代码 start (一个网页只需插入一次) -->
<script type="text/javascript">
var duoshuoQuery = {short_name:"futureweb"};
	(function() {
