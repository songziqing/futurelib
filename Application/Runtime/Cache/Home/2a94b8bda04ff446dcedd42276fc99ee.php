...
<!---- animated-css ---->
<script src="/futurelib/Public/js/jquery-1.11.0.min.js"></script>
</head>
<body>
<!--header start here-->
<div class="header">
	<div class="container head-nav-back">
		<div class="header-main">
			...
			<div class="navg">
				...
				<ul class="res">
					<li><a class="active" href="/futurelib/index.php/Home/Index/index">首页</a></li>
...
<div class="container-fluid">
	<div class="row">
		<iframe scrolling="no" frameborder="0" src="/futurelib/index.php/Home/Index/play" style="width:100%; height:450px">
		</iframe>
	</div>    
</div>
<!--banner end here-->
	...
	<div class="container">
		<div class="info-grid-main">
			<div class="col-md-4 info-grids-cr wow bounceIn" data-wow-delay="0.4s">
				...
				<div class="info-bott">
					<img src="/futurelib/Public/images/c1.jpg" alt=""/>
					<p> 简介：NBA数据分析项目<br>
