		...
		<div class="header-main">
			...
			<div class="navg">
				...
				<ul class="res">
					...
					<li><a class="active" href="/futurelib/index.php/Home/Index/about">关于</a></li>
					<li><a href="/futurelib/index.php/Home/Index/introduce">展示</a></li>
					<li><a href="/futurelib/index.php/Home/Index/news">动态</a></li>
					<li><a href="/futurelib/index.php/Home/Index/contact">联系</a></li>
				</ul>
				 <script>
	...
	<div class="container">
		<div class="about-main">
			<div class="col-md-4 about-left wow bounceIn" data-wow-delay="0.4s">
				<h3>关于未来</h3>
				<img src="/futurelib/Public/images/ab.jpg" alt=""/>
			</div>
			<div class="col-md-8 about-left wow bounceIn" data-wow-delay="0.4s">
				...
				<h4>scrambled it to make a type specimen</h4>
				<p>Since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
			    <h4>scrambled it to make a type specimen</h4>
			    <p> It has survivednot only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
			</div>
		...
		<div class="team-main" > 
			<h3>我们的团队</h3>
			 <div class="col-md-3 team-grids wow bounceIn " data-wow-delay="0.4s">
			 	<a href="#"><img src="/futurelib/Public/images/ram.jpg" alt="" class="thumbnail" /></a>
			 	<p style="font-size:15px; margin-top:20px">事实上，在欧盟对微软的反垄断调查中，"捆绑销售"是微软滥用市场支配地位取得垄断利益的主要表现。地位取得垄断利益的主要表现。</p>
			 </div>
			 <div class="col-md-3 team-grids wow bounceIn" data-wow-delay="0.4s">
			 
			 	<a href="#"><img src="/futurelib/Public/images/t1.jpg" alt=""/></a>
			 	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
			 </div>
			 <div class="col-md-3 team-grids wow bounceIn" data-wow-delay="0.4s">
			 	<a href="#"><img src="/futurelib/Public/images/t3.jpg" alt=""/></a>
			 	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
			 </div>
			 <div class="col-md-3 team-grids wow bounceIn" data-wow-delay="0.4s">
			 	<a href="#"><img src="/futurelib/Public/images/t2.jpg" alt=""/></a>
			 	<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
			 </div>
		  <div class="clearfix"> </div>
		</div>
